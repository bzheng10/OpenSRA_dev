...
class SasakiEtal2022(WellStrain):
    ...
    _MODEL_INPUT_INFRA = {
        ...
        'params': {
            'phi_cmt': 'friction angle of cement (deg) - for mode 3 + cemented tubing only',
    ...
    _MODEL_FORM = {
        'func': {
            ...
            'mode_1_uncemented_casing': \
                lambda b0, b1, b2, b3, b4, theta, pgdef: \
                b0 + b1*theta + b2*theta**2 + b3*np.log(pgdef) + b4*np.log(pgdef)**2,
            'mode_1_cemented_casing': \
            ...
            'mode_3_cemented_tubing': \
                ...
                b0 + b1*theta + b2*theta**2 + b3*w_fc + b4*w_dz + b5*phi_cmt + \
        ...
        'aleatory': {
            ...
            'mode_3_uncemented_tubing': 0.5203696,
            'mode_3_cemented_tubing': 0.1015194,
            'mode_3_uncemented_casing': 0.0306518,
            'mode_3_cemented_casing': 0.0399986,
    ...
    def get_req_rv_and_fix_params(cls, kwargs):
        ...
        # modes present
        modes = [num for num in [1, 3, 4] if num in mode]
