...
# -----------------------------------------------------------
class PipeFailure(BaseModel):
    "Inherited class specfic to pipe failure (compressive rupture, tensile rupture, tensile leakage)"
...
# -----------------------------------------------------------
class BainEtal2022(PipeFailure):
    """
    Compute probability of pipe failure (compressive rupture, tensile rupture, tensile leakage) using Bain et al. (2022).
    ...
    Returns
    -------
    eps_pipe_comp_crit_rup : np.ndarray or list
        [%] mean critical compressive pipe strain for rupture
    eps_pipe_tens_crit_rup : np.ndarray or list
        [%] mean critical tensile pipe strain for rupture
    eps_pipe_tens_crit_leak : np.ndarray or list
