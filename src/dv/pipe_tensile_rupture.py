...
# -----------------------------------------------------------
class PipeTensileRupture(BaseModel):
    "Inherited class specfic to tensile pipe rupture"
...
# -----------------------------------------------------------
class BainEtal2022(PipeTensileRupture):
    """
    Compute probability of tensile pipe rupture using Bain et al. (2022).
    ...
    def _model(
        ...
        # calculations
        eps_tens_crit_rup = 4.68 # %
        
        # prepare outputs
        output = {
            'eps_tens_crit_rup': {
                'mean': eps_tens_crit_rup,
                'sigma': 0.3,
                'sigma_mu': 0.25,
                'dist_type': 'lognormal',
                'unit': '%'
