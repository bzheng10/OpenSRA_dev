...
# -----------------------------------------------------------
class WellheadRupture(BaseModel):
    "Inherited class specfic to rupture for wellhead subsystem components"
...
# -----------------------------------------------------------
class BainEtal2022(WellheadRupture):
    """
    Compute probability of rupture for wellhead subsystem components using Bain et al. (2022).
