...
# -----------------------------------------------------------
class WellheadTensileLeakage(BaseModel):
    "Inherited class specfic to tensile leakage for subsystem components"
...
# -----------------------------------------------------------
class BainEtal2022(WellheadTensileLeakage):
    """
    Compute probability of tensile leakage for wellhead subsystem components using Bain et al. (2022).
