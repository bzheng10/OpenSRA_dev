...
# -----------------------------------------------------------
class WellheadTensileRupture(BaseModel):
    "Inherited class specfic to tensile rupture for wellhead subsystem components"
...
# -----------------------------------------------------------
class BainEtal2022(WellheadTensileRupture):
    """
    Compute probability of tensile rupture for wellhead subsystem components using Bain et al. (2022).
    ...
    def _model(
        ...
        output_mean = {
            ##########################
            'eps_crit_rup_sys2_4E90_jointA_xdir_pos': 4.68,
            'eps_crit_rup_sys2_4E90_jointA_xdir_neg': 4.68,
            'eps_crit_rup_sys2_4E90_jointA_ydir_pos': 4.68,
            'eps_crit_rup_sys2_4E90_jointA_ydir_neg': 4.68,
            ##########################
            'eps_crit_rup_sys2_4TIP_jointA_xdir_pos': 4.68,
            'eps_crit_rup_sys2_4TIP_jointA_xdir_neg': 4.68,
            'eps_crit_rup_sys2_4TIP_jointA_ydir_pos': 4.68,
            'eps_crit_rup_sys2_4TIP_jointA_ydir_neg': 4.68,
            ##########################
            'eps_crit_rup_sys3_4E90_jointB_xdir_pos': 4.68,
            'eps_crit_rup_sys3_4E90_jointB_xdir_neg': 4.68,
            'eps_crit_rup_sys3_4E90_jointA_ydir_pos': 4.68,
            'eps_crit_rup_sys3_4E90_jointA_ydir_neg': 4.68,
            ##########################
            'eps_crit_rup_sys3_4TOP_jointA_xdir_pos': 4.68,
            'eps_crit_rup_sys3_4TIP_jointB_xdir_pos': 4.68,
            'eps_crit_rup_sys3_4TIP_jointB_xdir_neg': 4.68,
            'eps_crit_rup_sys3_4TIP_jointA_ydir_pos': 4.68,
            'eps_crit_rup_sys3_4TIP_jointA_ydir_neg': 4.68,
            ##########################
            'eps_crit_rup_sys4_4E90_jointA_ydir_pos': 4.68,
            'eps_crit_rup_sys4_4E90_jointA_ydir_neg': 4.68,
            ##########################
            'eps_crit_rup_sys4_4TIP_jointA_ydir_pos': 4.68,
            'eps_crit_rup_sys4_4TIP_jointA_ydir_neg': 4.68,
            'eps_crit_rup_sys4_4TOP_jointC_ydir_pos': 4.68,
        }
